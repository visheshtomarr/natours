...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (location) {
    ...
    element.className = 'marker'; // Add marker to map
...
var stripe = Stripe('pk_test_51RHOpSIh9pWgSR9YMyHWapf1mjojx3Ys3fHoszySfcDMLmyP3H0K9g7e89t59weha8S3AnPrzTuOUClckdDjpb6p00JxFrqFNe');
...
var signupForm = document.querySelector('.signup-form'); // Delegation
